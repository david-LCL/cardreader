...
#include "my_spi.h" /* This header file is needed to use with M52259DEMO */

#define spi_send_read_byte(byte)	spi0_send_read_byte(byte)
...
// #include "delays.h" /* This delay function can not be used with M52259DEMO */

#include <mqx.h>	
#include <bsp.h>

void my_delay_us(int us); /*  This delay function is defined for M52259DEMO */
#define delay_us(microseconds)	  my_delay_us(microseconds)  

// #define delay_us(microseconds)	  _time_delay(1) /* this _time_delay function takes in milisecond, not us */
...
/////////////////////////////////////////////////////////////////////////////////////
// #include "mcf5xxx.h"
// #include "MCF52259_GPIO.h"	// #include "lpc214x.h"
...
#define nrf24l01_CE_IOREGISTER		MCF_GPIO_PORTAN		/* Redefined nrf24l01_CE for M52259DEMO's spi pins */
#define nrf24l01_CE_PINMASK			MCF_GPIO_PORTAN_PORTAN0
...
// #define nrf24l01_CSN_IOREGISTER		MCF_GPIO_PORTQS		/* Mapped CSN to portQS, not tested yet */
// #define nrf24l01_CSN_PINMASK		MCF_GPIO_PORTQS_PORTQS3

#define nrf24l01_CSN_IOREGISTER		0 /* nrf24l01 is always active, should be mapped to QS port */
#define nrf24l01_CSN_PINMASK		0
...
#define nrf24l01_IRQ_IOREGISTER		MCF_GPIO_SETNQ /* IRQ pin must be used to control nrf24l01 */
#define nrf24l01_IRQ_PINMASK		MCF_GPIO_SETNQ_SETNQ7
